...
@section('content')
     <div id="container">
            ...
            <ul>
              <li>
                ...
                <li style="background-color: rgb(245, 245, 245)">
                  <a style="display: flex;align-items: center;color: black" href="{{'/guru'}}"><iconify-icon style="margin-right: 10px" icon="ph:chalkboard-teacher" width="27" height="27"></iconify-icon>Data Guru</a>
                </li>
                <li>
        ...
        <div id="content">
            ...
            <div id="isi">
                  ...
                  <!-- Modal -->
                  <form method="post" action="/tambahguru/store">
                    @csrf
                ...
                {{-- modal edit --}}
                <form method="post" action="{{route('updateguru')}}">
                  @csrf
                <div class="modal fade" id="edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        @include('dashboard-admin/guru/formedit')
                      </div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-primary">Save changes</button>
              ...
              {{-- delete --}}
              <form method="post" action="{{route('hapusguru')}}">
                @csrf
              <div class="modal fade" id="delete" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      @include('dashboard-admin/guru/formhapus')
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
  ...
  var nisn = button.data('nip')
  var kelas = button.data('matpel')

  var id = button.data('id')
  
  var modal = $(this)
  modal.find('#nama').val(nama)
  modal.find('#nip').val(nisn)
  modal.find('#matpel').val(kelas)
