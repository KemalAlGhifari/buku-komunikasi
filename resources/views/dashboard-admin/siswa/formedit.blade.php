<div style="display: block;margin-bottom: 20px">
  ...
  <input style="width: 100%;font-size: 15px;padding: 8px;box-sizing: border-box;height: 30px;font-family: 'Quicksand', sans-serif;border: 1px solid rgb(187, 187, 187);border-radius: 2px" type="text" name="nama" id="nama">
</div>
<div style="display: block;margin-bottom: 20px">
  <label style="margin-bottom: 0.5%;font-weight: bold" for="">NISN :</label><br>
  <input style="width: 100%;font-size: 15px;padding: 8px;box-sizing: border-box;height: 30px;font-family: 'Quicksand', sans-serif;border: 1px solid rgb(187, 187, 187);border-radius: 2px" type="number" name="nisn" id="nisn">
</div>
<div style="display: block;margin-bottom: 20px">
...
<div style="display: block;margin-bottom: 20px">
  ...
  <input style="width: 100%;font-size: 15px;padding: 8px;box-sizing: border-box;height: 30px;font-family: 'Quicksand', sans-serif;border: 1px solid rgb(187, 187, 187);border-radius: 2px" type="text" name="jurusan" id="jurusan">
</div>
<div style="display: block;margin-bottom: 20px">
