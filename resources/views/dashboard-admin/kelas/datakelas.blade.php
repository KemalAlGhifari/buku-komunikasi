            ...
            <ul>
              <li>
                ...
                <li  style="background-color: rgb(245, 245, 245)">
                  <a style="display: flex;align-items: center;color: black" href="{{'/kelas'}}"><iconify-icon style="margin-right: 10px" icon="teenyicons:school-outline" width="27" height="27"></iconify-icon>Data Kelas</a>
                </li>
            </ul>
        </div>
        <div id="content">
            ...
            <div id="isi">
                  ...
                  <!-- Modal -->
                  <form method="post" action="/tambahkelas/store">
                    @csrf
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          @include('dashboard-admin/kelas/form')
                        </div>
                ...
                <div id="ctable">
                  <table  id="table" class="table table-striped">
                    <tr style="border-top: 1px solid rgb(170, 170, 170);text-align: center">
                      ...
                      <td style="width: 10%;">Wali Kelas</td>
