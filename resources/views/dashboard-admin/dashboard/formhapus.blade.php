...
<div style="display: block;margin-bottom: 20px">
  ...
  <input disabled style="width: 100%;font-size: 15px;padding: 8px;box-sizing: border-box;height: 30px;font-family: 'Quicksand', sans-serif;border: 1px solid rgb(187, 187, 187);border-radius: 2px" type="text" name="pelanggaran" id="pelanggaran">
</div>
<div style="display: block;margin-bottom: 20px">
